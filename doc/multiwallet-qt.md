...
In order to support loading of multiple wallets in tradetensor-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tradetensor.cpp.
...
Changes to tradetensor.cpp
----------------------
tradetensor.cpp is the entry point into tradetensor-qt, and as such, will require some minor modifications to provide hooks for
