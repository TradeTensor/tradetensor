...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/tradetensor-project/tradetensor/gitian.sigs.git
...
### Build and sign Tradetensor Core for Linux, Windows, and OS X:

    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit tradetensor=v${VERSION} ../tradetensor/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit tradetensor=v${VERSION} ../tradetensor/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit tradetensor=v${VERSION} ../tradetensor/contrib/gitian-descriptors/gitian-osx.yml
    ...
    ./bin/gbuild --memory 3000 --commit tradetensor=v${VERSION} ../tradetensor/contrib/gitian-descriptors/gitian-aarch64.yml
    ./bin/gsign --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs/ ../tradetensor/contrib/gitian-descriptors/gitian-aarch64.yml
    mv build/out/tradetensor-*.tar.gz build/out/src/tradetensor-*.tar.gz ../
    popd
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`tradetensor-${VERSION}-osx-unsigned.dmg`, `tradetensor-${VERSION}-osx64.tar.gz`)
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import tradetensor/contrib/gitian-keys/*.gpg
    gpg --refresh-keys
...
Codesigner only: Sign the osx binary:
    ...
    transfer tradetensor-osx-unsigned.tar.gz to osx for signing
...
space *do not upload these to the tradetensorcoin.com server*.
