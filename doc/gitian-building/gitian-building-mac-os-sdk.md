...
The script [extract-osx-sdk.sh](https://github.com/tradetensor-project/tradetensor/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
tradetensor/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/tradetensor-project/tradetensor/blob/master/doc/README_osx.md) for troubleshooting tips.