...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/tradetensor-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/tradetensor-cli.cpp \
           src/tradetensor-tx.cpp \
           src/tradetensor.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/tradetensor.qrc src/qt/tradetensor_locale.qrc

TRANSLATIONS += src/qt/locale/tradetensor_bg.ts \
                src/qt/locale/tradetensor_de.ts \
                src/qt/locale/tradetensor_en.ts \
                src/qt/locale/tradetensor_es.ts \
                src/qt/locale/tradetensor_fi.ts \
                src/qt/locale/tradetensor_fr.ts \
                src/qt/locale/tradetensor_it.ts \
                src/qt/locale/tradetensor_ja.ts \
                src/qt/locale/tradetensor_pl.ts \
                src/qt/locale/tradetensor_pt.ts \
                src/qt/locale/tradetensor_ru.ts \
                src/qt/locale/tradetensor_sk.ts \
                src/qt/locale/tradetensor_sv.ts \
                src/qt/locale/tradetensor_vi.ts \
                src/qt/locale/tradetensor_zh_CN.ts \
                src/qt/locale/tradetensor_zh_TW.ts
