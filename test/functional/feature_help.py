...
"""Verify that starting tradetensor with -h works as expected."""
import subprocess

from test_framework.test_framework import TradeTensorTestFramework
from test_framework.util import assert_equal

class HelpTest(TradeTensorTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tradetensor with -h for help text")
        ...
        self.log.info("Start tradetensor with -version for version information")
