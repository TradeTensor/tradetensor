...
from test_framework.tradetensor_node import TradeTensorTestNode
...
class TradeTensor_ColdStakingTest(TradeTensorTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(TradeTensorTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 TNSR from the pot)
...
if __name__ == '__main__':
    TradeTensor_ColdStakingTest().main()
