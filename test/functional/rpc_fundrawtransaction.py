...
class RawTransactionsTest(TradeTensorTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid tradetensor address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid tradetensor address" in e.error['message'])
