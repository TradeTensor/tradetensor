Contributing to TradeTensor Core
============================

The TradeTensor Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/tradetensor-project/tradetensor/blob/master/doc/translation_process.md)
...
The following applies to code changes to the TradeTensor Core project, and is not to be
confused with overall TradeTensor Network Protocol consensus changes.

Whether a pull request is merged into TradeTensor Core rests with the project merge
...
Patches that change TradeTensor consensus rules are considerably more involved than
...
Where a patchset proposes to change the TradeTensor consensus, it must have been
...
The project leader is the release manager for each TradeTensor Core release.
