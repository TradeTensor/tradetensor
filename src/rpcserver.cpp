...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Tradetensor server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Tradetensor server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Tradetensor features */
        {"tradetensor", "masternode", &masternode, true, true, false},
        {"tradetensor", "listmasternodes", &listmasternodes, true, true, false},
        {"tradetensor", "getmasternodecount", &getmasternodecount, true, true, false},
        {"tradetensor", "masternodeconnect", &masternodeconnect, true, true, false},
        {"tradetensor", "masternodecurrent", &masternodecurrent, true, true, false},
        {"tradetensor", "masternodedebug", &masternodedebug, true, true, false},
        {"tradetensor", "startmasternode", &startmasternode, true, true, false},
        {"tradetensor", "createmasternodekey", &createmasternodekey, true, true, false},
        {"tradetensor", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"tradetensor", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"tradetensor", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"tradetensor", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"tradetensor", "getmasternodescores", &getmasternodescores, true, true, false},
        {"tradetensor", "mnbudget", &mnbudget, true, true, false},
        {"tradetensor", "preparebudget", &preparebudget, true, true, false},
        {"tradetensor", "submitbudget", &submitbudget, true, true, false},
        {"tradetensor", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"tradetensor", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"tradetensor", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"tradetensor", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"tradetensor", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"tradetensor", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"tradetensor", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tradetensor", "checkbudgets", &checkbudgets, true, true, false},
        {"tradetensor", "mnsync", &mnsync, true, true, false},
        {"tradetensor", "spork", &spork, true, true, false},
        {"tradetensor", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"tradetensor", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use tradetensord, or the -server option to tradetensor-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> tradetensor-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:37413/\n";
}
