...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Tradetensor Core tradetensor-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tradetensor-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tradetensor transaction") + "\n" +
                               "  tradetensor-tx [options] -create [commands]   " + _("Create hex-encoded tradetensor transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tradetensor transaction
