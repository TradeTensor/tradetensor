...
public:
    ...
    bool CreateZTNSROutPut(libzerocoin::CoinDenomination denomination, CTxOut& outMint, CDeterministicMint& dMint);
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzTNSRTracker> zpivTracker;
    ...
    /// Get 10000 TNSR output and keys which can be used for the Masternode
