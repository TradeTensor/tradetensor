...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 30130;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // TradeTensor starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 500;
        nTradeTensorBadBlockTime = 4070908800; // Skip nBit validation of Block 259201 per PR #915
        nTradeTensorBadBlocknBits = 0x00; // Skip nBit validation of Block 259201 per PR #915
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "He had reached the point where he was paranoid.";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1594895847;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1737284;
...
/*if(genesis.GetHash() != uint256("0x"))
        ...
        assert(hashGenesisBlock == uint256("000004b5ea753015cf34c191f90cc44efd9148fcba30c89c6bdd7bc878b6e376"));
       assert(genesis.hashMerkleRoot == uint256("33a532c77f25b797f0e7d9b95dc622e8b684fe95ee3015a54fd9323a4a675a54"));
	...
	vSeeds.push_back(CDNSSeedData("140.82.10.116", "140.82.10.116"));
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65);      // starting with 'H'
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nTradeTensorBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nTradeTensorBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "tradetensor-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "tradetensor-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("warrows.dev", "testnet.dnsseed.tradetensor.warrows.dev"));
