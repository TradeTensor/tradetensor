...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0433a84a4f5ba8fdadfedeb4d2782429574439c0ddc9b013c0ef3378227b812502a60f06be0cf351120031de83dd6ae562c00f62b29722fa1ad06c9feea6e349bd");
        nDefaultPort = 27413;
       bnProofOfWorkLimit = ~uint256(0) >> 20;
        ...
        const char* pszTimestamp = "be sure to save new images that are exactly the same size";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("043ad3e34ac426f294b26df63a345645880bb8748772ebd4e9e3d9db528036506168d007fc7a55c22461046b6ea648fd8a588f6d5bccafd549fba72c707ea1bcd8") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1592932400;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2782688;
        ...
        assert(hashGenesisBlock == uint256("0x000009b91b10415e29bedd19f4ad45f21e79debc27fc070e6a5594ee7821a2d4"));
        assert(genesis.hashMerkleRoot == uint256("0x922165c2223917b7a2654a7c04cd0f0262115b0465faf287e164fc17d4bb2aff"));
		
        vSeeds.push_back(CDNSSeedData("149.28.58.146", "149.28.58.146"));
        vSeeds.push_back(CDNSSeedData("149.28.43.182", "149.28.43.182"));
        vSeeds.push_back(CDNSSeedData("104.156.225.64", "104.156.225.64"));
        vSeeds.push_back(CDNSSeedData("108.61.90.121", "108.61.90.121"));
		vSeeds.push_back(CDNSSeedData("207.246.123.8", "207.246.123.8"));
		vSeeds.push_back(CDNSSeedData("140.82.10.116", "140.82.10.116"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // TradeTensor: 1 day
        nTargetSpacing = 1 * 60;  // TradeTensor: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testnet.tnsr.io", "testnet.tnsr.io"));         // Single node address
        vSeeds.push_back(CDNSSeedData("testnet1.tnsr.io", "testnet1.tnsr.io"));       // Single node address
        vSeeds.push_back(CDNSSeedData("testnet.tradetensorcoin.org", "testnet.tradetensorcoin.org"));       // Single node address


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet tradetensor addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet tradetensor script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet tradetensor BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet tradetensor BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet tradetensor BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // TradeTensor: 1 day
        nTargetSpacing = 1 * 60;        // TradeTensor: 1 minutes
