...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("047f8d0734cb094cafdfcfb1fadb57f4ae2091da92d2fffcf7a94f22caa15e6aa57093b87ae98ac667ede65894328940f9af29771d250bce4275fd5f3d04daaaf6");
        nDefaultPort = 30130;
       bnProofOfWorkLimit = ~uint256(0) >> 20;
        ...
        const char* pszTimestamp = "be sure to save new images exactly the same size";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("044ed019046f9878fd7b5bce03f44a7995364763622c1da61504995a65c5ac235eb24cc34f483c95441b9926d84ca2c602d4f9a821fde6e862881731f8dd5f05b5") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1595722454;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 87385;
        ...
        assert(hashGenesisBlock == uint256("0x00000319af25c023740d7d1c108115ec8feab661024e07b68123d34e80817f11"));
        assert(genesis.hashMerkleRoot == uint256("0x28e106954205fe9dbbd27739c2fa4d3951ab391db74a01e3eb47c6a755e3b25a"));
