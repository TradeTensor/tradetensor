/* src/config/tradetensor-config.h.  Generated from tradetensor-config.h.in by configure.  */
/* src/config/tradetensor-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/tradetensor-project/tradetensor/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "TradeTensor Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "TradeTensor Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "tradetensor"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://tradetensor.org/"
