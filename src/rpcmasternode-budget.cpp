...
Value mnbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a Tradetensor initiative\n"
            "  vote-alias         - Vote on a Tradetensor initiative\n"
            "  vote               - Vote on a Tradetensor initiative/budget\n"
...
Value submitbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"tradetensor-address\" monthy-payment \"fee-tx\"\n"
