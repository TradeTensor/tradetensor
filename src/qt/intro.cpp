...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Tradetensor [TNSR] v2"),
     ...
     * override -datadir in the tradetensor.conf file in the default data directory
     * (to be consistent with tradetensord behavior)
     */
    if (dataDir != getDefaultDataDirectory())
