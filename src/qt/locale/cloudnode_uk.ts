...
<context>
    ...
    <message>
        ...
        <translation>Cloudnode зараз закриється, щоб завершити процес шифрування. Пам'ятайте, що шифрування гаманця не може повністю захистити ваші TNSR'и від крадіжки зловмисним програмним забезпеченням, що заражає ваш комп'ютер.</translation>
    </message>
    <message>
