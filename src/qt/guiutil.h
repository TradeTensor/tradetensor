...
/** Utility functions used by the Tradetensor Qt UI.
 */
namespace GUIUtil
{
...
// Render Tradetensor addresses in monospace font
...
// Parse "tradetensor:" URI into recipient object, return true on successful parsing
