...
// Copyright (c) 2015-2018 The TradeTensor developers
...
/* TradeTensor GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "TradeTensor"
#define QAPP_ORG_DOMAIN "tradetensor.org"
#define QAPP_APP_NAME_DEFAULT "TradeTensor-Qt"
#define QAPP_APP_NAME_TESTNET "TradeTensor-Qt-testnet"
