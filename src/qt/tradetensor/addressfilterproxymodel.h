...
#ifndef TradeTensor_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define TradeTensor_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //TradeTensor_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
