...
#include "qt/tradetensor/forms/ui_coldstakingwidget.h"
#include "qt/tradetensor/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/tradetensor/requestdialog.h"
#include "qt/tradetensor/tooltipmenu.h"
#include "qt/tradetensor/furlistrow.h"
...
#include "qt/tradetensor/csrow.h"
...
ColdStakingWidget::ColdStakingWidget(TradeTensorGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your TNSRs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept TNSR delegation / Delegate TNSR"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select TNSR outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 TNSR" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
