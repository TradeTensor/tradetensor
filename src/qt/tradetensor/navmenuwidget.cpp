...
#include "qt/tradetensor/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(TradeTensorGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-tradetensor");
