...
#include "qt/tradetensor/forms/ui_dashboardwidget.h"
#include "qt/tradetensor/sendconfirmdialog.h"
#include "qt/tradetensor/txrow.h"
...
DashboardWidget::DashboardWidget(TradeTensorGUI* parent) :
    PWidget(parent),
    ui(new Ui::DashboardWidget)
{
    ...
    ui->labelAmountPiv->setText("0 TNSR");
...
const QMap<int, std::pair<qint64, qint64>> DashboardWidget::getAmountBy() {
    ...
    for (int i = 0; i < size; ++i) {
        ...
        bool isPiv = modelIndex.data(TransactionTableModel::TypeRole).toInt() != TransactionRecord::StakeZTNSR;
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair TNSR, zTNSR
