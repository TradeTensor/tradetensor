...
#include "qt/tradetensor/forms/ui_addresseswidget.h"
#include "qt/tradetensor/addresslabelrow.h"
#include "qt/tradetensor/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(TradeTensorGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter TradeTensor address"));
