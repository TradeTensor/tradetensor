...
#include "qt/tradetensor/settings/settingsnetworkwidget.h"
#include "qt/tradetensor/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/tradetensor/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(TradeTensorGUI* _window, QWidget *parent) :
