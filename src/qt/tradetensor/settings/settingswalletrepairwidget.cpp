...
#include "qt/tradetensor/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/tradetensor/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(TradeTensorGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to TradeTensorGUI::handleRestart()
