...
#include "qt/tradetensor/settings/settingssignmessagewidgets.h"
#include "qt/tradetensor/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(TradeTensorGUI* _window, QWidget *parent) :
