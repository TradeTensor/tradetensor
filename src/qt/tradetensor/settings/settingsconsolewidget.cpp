...
#include "qt/tradetensor/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/tradetensor/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(TradeTensorGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the TradeTensor RPC console.") + "<br>" +
