...
#include "qt/tradetensor/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/tradetensor/lockunlock.h"
#include "qt/tradetensor/qtutils.h"
#include "qt/tradetensor/receivedialog.h"
...
TopBar::TopBar(TradeTensorGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("TradeTensor")
    updateDisplayUnit();
