...
std::list<std::string> ZTnsrControlDialog::listSelectedMints;
std::list<CZerocoinMint> ZTnsrControlDialog::listMints;
...
void ZTnsrControlDialog::updateLabels()
{
    ...
    privacyDialog->setZTnsrControlLabels(nAmount, listSelectedMints.size());
}

std::vector<CZerocoinMint> ZTnsrControlDialog::GetSelectedMints()
{
