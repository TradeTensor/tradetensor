                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Tradetensor [TNSR] v2") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Tradetensor address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tradetensor: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Tradetensor Core"), this);
    aboutAction->setStatusTip(tr("Show information about Tradetensor Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Tradetensor"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Tradetensor addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Tradetensor addresses"));
    ...
    openAction->setStatusTip(tr("Open a Tradetensor: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Tradetensor Core help message to get a list with possible Tradetensor command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tradetensor network", "", count));
}
...
{
    QString strTitle = tr("Tradetensor [TNSR] v2"); // default title
